...
public class ConfirmFinalBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Total Rent = Rs. "+totalAmount,Toast.LENGTH_SHORT).show();
                ...
                if (task.isSuccessful()){
                    FirebaseDatabase.getInstance().getReference()
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        Toast.makeText(ConfirmFinalBookingActivity.this,"Booking Registered Successfully.",Toast.LENGTH_SHORT).show();
